# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 15:34:34 2017
...
class TwitterSearch(object):
    ...
    def construct_url(query, max_position=None):
        ...
        return urlparse.urlunparse(url_tupple)
...
#    twit.search(search_query)
    ...
    select_tweets_since = datetime.datetime.strptime("2015-01-14", '%Y-%m-%d')
    select_tweets_until = datetime.datetime.strptime("2015-03-15", '%Y-%m-%d')
    threads = 10
